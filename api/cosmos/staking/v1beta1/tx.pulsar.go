...
var (
	...
	fd_MsgEditValidator_dao_address         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgEditValidator_dao_address = md_MsgEditValidator.Fields().ByName("dao_address")
}
...
func (x *fastReflection_MsgEditValidator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DaoAddress != "" {
		value := protoreflect.ValueOfString(x.DaoAddress)
		if !f(fd_MsgEditValidator_dao_address, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgEditValidator) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.MsgEditValidator.min_self_delegation":
		return x.MinSelfDelegation != ""
	case "cosmos.staking.v1beta1.MsgEditValidator.dao_address":
		return x.DaoAddress != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgEditValidator) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.MsgEditValidator.min_self_delegation":
		x.MinSelfDelegation = value.Interface().(string)
	case "cosmos.staking.v1beta1.MsgEditValidator.dao_address":
		x.DaoAddress = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.MsgEditValidator"))
		}
...
func (x *fastReflection_MsgEditValidator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.MsgEditValidator.dao_address":
		panic(fmt.Errorf("field dao_address of message cosmos.staking.v1beta1.MsgEditValidator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.MsgEditValidator"))
		}
...
func (x *fastReflection_MsgEditValidator) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.DaoAddress) > 0 {
			i -= len(x.DaoAddress)
			copy(dAtA[i:], x.DaoAddress)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.DaoAddress)))
			i--
			dAtA[i] = 0x2a
		}
		if len(x.MinSelfDelegation) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field DaoAddress", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.DaoAddress = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *MsgEditValidator) GetDaoAddress() string {
	if x != nil {
		return x.DaoAddress
	}
	return ""
...
var file_cosmos_staking_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xf3, 0x03, 0x0a, 0x10,
	...
	0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x39, 0x0a, 0x0b, 0x64, 0x61, 0x6f, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d,
	0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x0a, 0x64, 0x61, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
